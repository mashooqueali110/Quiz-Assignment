...
import Result from "./FinalResultPage"
let value = 0;
                ...
                <Card style={{ width: '100%', backgroundColor:'lightgray' }}>
                    <Card.Body>
                        ...
                        <div >
                                    ...
                                    <Button className="App-btn" type="primary" onClick={decreament} >Previous</Button>
                                    <Button type="primary" onClick={changQuestion}  >{name}</Button>
